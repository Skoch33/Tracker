...
//  Tracker
//
//  Created by Semen Kocherga on 6.08.2023.
//
...
final class TrackerFormViewController: UIViewController {
    ...
    private lazy var cancelButton: UIButton = {
        ...
        button.backgroundColor = .ypWhiteDay
    ...
    func configureConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            colorsCollection.heightAnchor.constraint(
                equalToConstant: CGFloat(colors.count) / geoparams.cellCount * geoparams.height + geoparams.topInset + geoparams.bottomInset
            ),
...
extension TrackerFormViewController: UICollectionViewDelegateFlowLayout {
    ...
    {
        let availableSpace = collectionView.frame.width - geoparams.paddingWidth
        let cellWidth = availableSpace / geoparams.cellCount
        return CGSize(width: cellWidth, height: geoparams.height)
    }
    ...
    {
        UIEdgeInsets(
            top: geoparams.topInset,
            left: geoparams.leftInset,
            bottom: geoparams.bottomInset,
            right: geoparams.rightInset
        )
    }
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, minimumInteritemSpacingForSectionAt section: Int) -> CGFloat {
        geoparams.cellSpacing
    }
